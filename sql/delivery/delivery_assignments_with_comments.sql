...
CREATE TABLE delivery_assignments (
  ...
  /* ---------------------------------
     Tipo de asignación
     PICKUP: Recoger paquete (origen Bogotá)
     DELIVERY: Entregar paquete (destino Bogotá, en bodega)
  --------------------------------- */
  ...
  --------------------------------- */
  status ENUM(
    'PENDING',      -- Pendiente de ser recogido/entregado
    'IN_PROGRESS',  -- En progreso
    'COMPLETED',    -- Completado
    'CANCELLED'     -- Cancelado (reasignado a otro)
  ...
  /* ---------------------------------
     Keys & Constraints
  --------------------------------- */
  CONSTRAINT pk_delivery_assignments
...
CREATE TABLE assignment_history (
  ...
  --------------------------------- */
  action ENUM(
    'CREATED',      -- Asignación creada
    'REASSIGNED',   -- Reasignado a otro entregador
