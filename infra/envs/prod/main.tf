...
module "api_gateway" {
  ...
  # CORS - Orígenes permitidos (agregar dominio personalizado cuando esté listo)
...
module "frontend" {
  ...
  # Acceso público global (NO recomendado en prod - usar CloudFront)
  ...
  # CORS - En producción, restringir al dominio específico
  ...
  # Habilitar cuando se configure el dominio personalizado
...
# =============================================================================
# INSTRUCCIONES:
# 1. Configurar var.domain_name en variables.tf o en prod.tfvars
...
# 5. Si creaste una nueva hosted zone, actualizar los nameservers en tu registrador
# =============================================================================
...
#   domain_name        = var.domain_name  # Ej: "solutions-delivery.com"
#   subdomain          = ""               # "" para root, "app" para app.domain.com
#   create_www_alias   = true             # Crear alias www en producción
#
#   # Route53
